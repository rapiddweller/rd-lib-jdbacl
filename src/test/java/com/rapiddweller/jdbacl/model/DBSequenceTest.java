...
public class DBSequenceTest {
  ...
  /**
   * Test get start if not default 2.
   */
  @Test
  ...
  /**
   * Test get increment if not default.
   */
  @Test
  ...
  /**
   * Test get increment if not default 2.
   */
  @Test
